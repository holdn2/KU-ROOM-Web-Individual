...
import Button from '../../components/profilesetting/Button/Button';
...
const departments = {
    ...
    '건축대학': ['건축학부'],
    '공과대학': ['사회환경공학부', '기계항공공학부', '전기전자공학부', '화학공학부', '컴퓨터공학부', '산업경영공학부 산업공학과', '산업경영공학부 신산업융합학과', '생물공학과', 'K뷰티산업융합학과', '기계・로봇・자동차공학부', '화공학부', '첨단융합공학부 재료공학과', '첨단융합공학부 항공우주・모빌리티공학과', '첨단융합공학부 생물공학과', '첨단융합공학부 산업공학과', '공과대학자유전공학부'],
    '사회과학대학': ['정치외교학과', '경제학과', '행정학과', '국제무역학과', '응용통계학과', '융합인재학과', '글로벌비즈니스학과', '사회과학대학융합전공학부'],
    '경영대학': ['경영학과', '기술경영학과'],
    '부동산과학원': ['부동산학과'],
    ...
    '사범대학': ['일어교육과', '수학교육과', '체육교육과', '음악교육과', '교육공학과', '영어교육과', '교직과'],
    '상허교양대학': ['KU자유전공학부', '교양교육센터', '국제학부'],
    '국제대학': ['국제통상학과', '문화미디어학과', '국제교양교육센터'],
    '융합과학기술원': ['첨단바이오공학부', '생명공학부 시스템생명공학과', '생명공학부 융합생명공학과', '융합과학기술원자유전공학부'],
    '생명과학대학': ['동물자원・식품과학・유통학부 동물자원전공', '동물자원・식품과학・유통학부 식품과학전공','동물자원・식품과학・유통학부 식품유통전공', '환경보건・산림조경학부 환경보건전공', '환경보건・산림조경학부 산림조경전공', '생명과학특성학과', '식량자원과학과', '생명과학대학자유전공학부']
};
    ...
    <div className="profile-setting">
      <div className="profile-setting-header">
        ...
        <h1 className="profile-setting-title">
          <span className="text-primary">쿠룸</span>에 필요한<br />
          프로필을 설정해주세요.
        </h1>
      </div>
